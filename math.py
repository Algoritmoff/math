...
def double_mult_1_11():
    main_window.end_time = round(time() - main_window.start_time)
    ex_time_2.setText(str(main_window.end_time))
    main_window.start_time = time()
...
lb_time_2 = QLabel('Время: ')
lb_time_2.setFont(font16)
ex_time_2 = QLabel(str(main_window.end_time))
ex_time_2.setFont(font16)
lb_example_2 = QLabel()
...
row_2_2 = QHBoxLayout()
row_2_2.addWidget(lb_time_2)
row_2_2.addWidget(ex_time_2)
